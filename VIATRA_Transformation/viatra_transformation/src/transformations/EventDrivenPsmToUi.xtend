...
class EventDrivenPsmToUi {
    ...
    private def createTransformation() {
    	...
    	fixedPriorityResolver.setPriority(getModifyRoleViewFieldRule().ruleSpecification, priority++)
    	...
    	fixedPriorityResolver.setPriority(getModifyParameterViewFieldRule().ruleSpecification, priority++)
        ...
        transformation = EventDrivenTransformation.forEngine(engine)
            ...
            .addRule(getModifyRoleViewFieldRule)
     	    .addRule(getModifyOperationRule)
            .addRule(getModifyParameterRule)
            .addRule(getModifyParameterViewFieldRule)
