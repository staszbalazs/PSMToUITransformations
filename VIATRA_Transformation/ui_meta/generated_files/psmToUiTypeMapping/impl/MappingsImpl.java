 ...
 * </p>
 * <ul>
 *   <li>{@link psmToUiTypeMapping.impl.MappingsImpl#getMappings <em>Mappings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MappingsImpl extends MinimalEObjectImpl.Container implements Mappings {
	...
	protected EClass eStaticClass() {
		return PsmToUiTypeMappingPackage.Literals.MAPPINGS;
	}
	...
	public EList<Mapping> getMappings() {
		if (mappings == null) {
			mappings = new EObjectContainmentEList<Mapping>(Mapping.class, this, PsmToUiTypeMappingPackage.MAPPINGS__MAPPINGS);
		}
		return mappings;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PsmToUiTypeMappingPackage.MAPPINGS__MAPPINGS:
