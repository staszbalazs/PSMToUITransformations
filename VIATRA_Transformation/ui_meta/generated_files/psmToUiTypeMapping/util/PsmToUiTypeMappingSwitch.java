 ...
 * @generated
 */
public class PsmToUiTypeMappingSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public PsmToUiTypeMappingSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PsmToUiTypeMappingPackage.MAPPING: {
				Mapping mapping = (Mapping)theEObject;
				T result = caseMapping(mapping);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PsmToUiTypeMappingPackage.MAPPINGS: {
